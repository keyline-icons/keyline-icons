...
**534 icons, drawn on one 24×24 grid, in three weights.** Built for shadcn/ui,
...
| --- | --- | --- |
| `stroke` | 534 | The full set. 2px keylines on a 24 grid. |
| `duotone` | 439 | The stroke drawing over a flat plate at reduced opacity. |
| `fill` | 391 | Solid, with the detail knocked back out of the shape. |

1,364 SVGs in total. `stroke` is complete by definition: it is the drawing every
