...
| --- | --- | --- |
| `stroke` | 527 | The full set. 2px keylines on a 24 grid. |
| `duotone` | 437 | The stroke drawing over a flat plate at reduced opacity. |
| `fill` | 389 | Solid, with the detail knocked back out of the shape. |
