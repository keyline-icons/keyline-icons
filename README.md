...
**719 icons, drawn on one 24×24 grid, in three weights.** Built for shadcn/ui,
...
| --- | --- | --- |
| `stroke` | 719 | The full set. 2px keylines on a 24 grid. |
| `duotone` | 584 | The stroke drawing over a flat plate at reduced opacity. |
