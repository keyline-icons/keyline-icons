...
**549 icons, drawn on one 24×24 grid, in three weights.** Built for shadcn/ui,
...
| --- | --- | --- |
| `stroke` | 549 | The full set. 2px keylines on a 24 grid. |
...
1,401 SVGs in total. `stroke` is complete by definition: it is the drawing every
