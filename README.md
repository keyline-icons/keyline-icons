...
**774 icons, drawn on one 24×24 grid, in three weights.** Built for shadcn/ui,
...
| --- | --- | --- |
| `stroke` | 774 | The full set. 2px keylines on a 24 grid. |
| `duotone` | 625 | The stroke drawing over a flat plate at reduced opacity. |
| `fill` | 576 | Solid, with the detail knocked back out of the shape. |

The table is one corner treatment. Every drawing is also cut with sharp corners,
so 3,950 SVGs in total.
