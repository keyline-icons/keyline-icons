...
719 icons on one 24×24 grid, as React components. Built for shadcn/ui, free
under MIT.
...
```tsx
import { Bell } from "@keyline-icons/react"          // stroke,  719 icons
import { Bell } from "@keyline-icons/react/duotone"  // duotone, 584 icons
import { Bell } from "@keyline-icons/react/fill"     // fill,    535 icons
```
