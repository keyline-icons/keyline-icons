...
599 icons on one 24×24 grid, as React components. Built for shadcn/ui, free
under MIT.
...
```tsx
import { Bell } from "@keyline-icons/react"          // stroke,  599 icons
import { Bell } from "@keyline-icons/react/duotone"  // duotone, 494 icons
import { Bell } from "@keyline-icons/react/fill"     // fill,    446 icons
```
