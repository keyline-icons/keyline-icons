...
550 icons on one 24×24 grid, as React components. Built for shadcn/ui, free
under MIT.
...
```tsx
import { Bell } from "@keyline-icons/react"          // stroke,  550 icons
import { Bell } from "@keyline-icons/react/duotone"  // duotone, 449 icons
import { Bell } from "@keyline-icons/react/fill"     // fill,    401 icons
```
