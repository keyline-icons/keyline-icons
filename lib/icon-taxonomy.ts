...
export const CATEGORIES = [
  ...
  {
    label: "New",
    match: /^(crown|flag|flag-chequered|traffic-light|bug|search-2?-(?:plus|minus|check|x|list)|cloud-(?:plus|minus|check|x|alert)|package-(?:plus|minus|check|x|alert|arrow-(?:down|up|left|right))|settings-dot|briefcase|umbrella|move|maximize-2|credit-card-2|replay|circle-dashed-play|circle-progress-play|app-(?:plus|minus|check|x|dot))$/,
