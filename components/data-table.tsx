    ...
    cell: ({ row }) => (
      <Badge variant="outline" className="px-1.5 text-muted-foreground">
        {row.original.status === "Done" ? (
          ...
          <DemoIcon name="circle-progress-half" fallback={LoaderIcon} />
        )}
        {row.original.status}
      </Badge>
    ),
  ...
  },
  {
    ...
    cell: () => (
      <DropdownMenu>
        ...
        >
          <DemoIcon name="more-vertical" fallback={EllipsisVerticalIcon} />
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline">
            <DemoIcon name="plus" fallback={PlusIcon} className="size-5" />
          ...
          <div className="flex w-full items-center gap-8 lg:w-fit">
            ...
            <div className="ml-auto flex items-center gap-2 lg:ml-0">
              ...
              >
                ...
                <DemoIcon name="chevrons-left" fallback={ChevronsLeftIcon} />
              </Button>
              <Button
                variant="outline"
                className="size-8"
              ...
              >
                ...
                <DemoIcon name="chevron-left" fallback={ChevronLeftIcon} />
              </Button>
              <Button
                variant="outline"
                className="size-8"
              ...
              >
                ...
                <DemoIcon name="chevron-right" fallback={ChevronRightIcon} />
              </Button>
              <Button
                variant="outline"
              ...
              >
                ...
                <DemoIcon name="chevrons-right" fallback={ChevronsRightIcon} />
              </Button>
            </div>
          </div>
        </div>
